...
void GLTFSceneBuffers::createDescriptorSet(vk::DescriptorPool& staticDescPool) {
...
[[nodiscard]] void GLTFSceneBuffers::_createRtBuffer(
    const nvh::GltfScene& gltfScene) {
  ...
  m_primlooks = m_alloc->createBuffer(cmdBuf, primLookup,
